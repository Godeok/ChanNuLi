...
public class GameMainActivity extends AppCompatActivity {
    ...
    public void OnClickHandler1(View view){
        ...
        builder.setTitle("하나빼기").setMessage("양 손으로 가위바위보를 먼저 한 다음, 둘 중 한 손을 내밀어 승패를 겨루는 게임입니다.");
    ...
    public void OnClickHandler2(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("간단 연산").setMessage("시간 제한 안에 간단한 덧셈, 뺄셈, 나눗셈, 곱셈 연산을 하는 게임입니다.");
    ...
    public void OnClickHandler3(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("카드 뒤집기").setMessage("똑같은 숫자가 적힌 카드 한 쌍을 찾는 게임입니다.");
        builder.setNeutralButton("OK", new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int id) {}
        });
